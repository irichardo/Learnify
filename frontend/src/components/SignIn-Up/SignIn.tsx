    ...
    <div className='min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5'>
      ...
      >
        <div className='md:flex w-full'>
          <div className='w-full md:w-1/2 pt-10 px-5 md:px-10'>
                  ...
                  <div className='w-full px-3 mb-5'>
                    <div className='flex justify-center pb-2 '>
                      <p className='text-base'>
                        ...
                        <Link
                          to='/register'
                          className='text-sm text-indigo-600 font-semibold hover:text-indigo-900 hover:font-bold hover:cursor-pointer'
                        >
                          click here
                        </Link>
                      </p>
                    ...
                    <button
                      className='block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-3xl px-3 py-3 font-semibold'
                      type='submit'
                    >
                      SIGN IN
                    </button>
