...
// import { regexEmailPwd } from "../../helpers/validation";
  ...
  return (
    <div className='bg-gray-400 flex justify-center items-center h-screen'>
      ...
      <div className='flex flex-row items-center' style={{ height: "600px" }}>
        <div className='flex flex-col items-center mx-auto justify-between max-w-7xl px-4 sm:px-6 lg:px-8 bg-gray-100 p-20 h-full rounded-l-3xl w-full md:w-1/2'>
          ...
          <p className='text-base font-medium text-gray-500 font-montserrat'>or use you account</p>
          <form action='form' className='flex flex-col items-center'>
            ...
            <p className='text-base font-medium text-blue-900 cursor-pointer hover:underline'>Forgot your password?</p>
            <button className='bg-blue-600 rounded-3xl text-white text-xl font-bold py-2 px-6 border border-blue-600 hover:bg-blue-700' type='submit'>
              SIGN IN
            </button>
          </form>
        </div>
        {/** ------------------------------------------ */}
        <div className='flex flex-col items-center mx-auto max-w-7xl px-4 lg:px-8 bg-gradient-to-r from-[#f3ecea] to-[#7C94F2] h-full rounded-r-3xl w-full md:w-1/2'>
          <div className='pt-10 pb-5 flex justify-center'>
            <img src={img} alt='logo' />
          </div>
          <h2 className='text-3xl font-bold text-gray-900 p-4'>Hi There!</h2>
          <p className='text-base font-semibold text-gray-600 p-3 '>Enter your personal details to open an account with us</p>
          <Link to='/register' className='bg-[#03263f93] rounded-3xl text-white text-xl font-bold py-2 px-6 border-none hover:bg-blue-400'>
            SIGN UP
          </Link>
        </div>
      </div>
